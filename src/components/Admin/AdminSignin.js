...
import {doAdminSignin} from "../../actions/Admin Actions";
...
class AdminSignin extends Component {
  ...
  onSubmit(values) {
    console.log(values);
    this.props.doAdminSignin(values);
  }
        ...
        <NavLogo>
          ...
          <div className="login-body">
            <div className="login-content login-form hybrid-login-form hybrid-login-form-signup">
              <div className="hybrid-login-form-main"><h1>Admin Sign In</h1>
              ...
              <div className="login-signup-now">New Admin User? <Link to="/adminSignup">Sign up for Admin now</Link>.
              </div>
            </div>
          </div>f
        </NavLogo>
...
export default reduxForm({
  validate,
  form: 'loginForm'
})(connect(mapStateToProps, mapDispatchToProps)(AdminSignin));
