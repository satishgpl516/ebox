...
import {doAdminSignup} from "../../actions/Admin Actions";
...
class Signup extends Component {
  ...
  onSubmit(values) {
    console.log(values);
    this.props.doAdminSignup(values);
  }
        ...
        <NavLogo>
          ...
          <div className="login-body">
            <div className="login-content login-form hybrid-login-form hybrid-login-form-signup">
              <div className="hybrid-login-form-main"><h1>Admin Sign Up</h1>
              ...
              <div className="login-signup-now">Already signed up? <Link to="/adminSignin">Admin Sign in</Link>.
              </div>
            </div>
          </div>
        </NavLogo>
