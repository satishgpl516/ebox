...
import {getMovieReviews, saveReview} from "../actions/MoviesActions";
...
class MovieReview extends Component {
  ...
  componentWillMount() {
    ...
    if(movie){ this.props.getMovieReviews(movie.movieId);}
                  ...
                  <div className="movieDetail-release-date text-center">
                    ...
                    <div className="rating-stars mt-2">
                      <ReactStars
                        ...
                        edit={false}
                        color2={'#ffd700'}
                        // value={this.props.movieReview.reviews ? _.sumBy(this.props.movie.movie.reviews, 'stars') / this.props.movie.movie.reviews.length : 0}
                      />
                    </div>
                    <small>
                ...
                <div className="col-md-7 p-0" onSubmit={this.handleSubmit}>
                  ...
                  <div className="form-review">
                    ...
                    <form className="pt-3 px-4" onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                      ...
                      <button
                        // className={`btn align-right ${new Date(this.props.movie.movie.release_date) > new Date() ? 'disabled' : ''}`}
                        type="submit">
                        Save Review
                      </button>
...
function mapStateToProps(state) {
  ...
  return {
    movieReview: state.movieRatingseviews,
  }
...
export default reduxForm({
  ...
  connect(mapStateToProps, {getMovieReviews, saveReview})(MovieReview)
);
